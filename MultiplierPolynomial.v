...
//altfp_mult CBX_AUTO_BLACKBOX="ALL" DEDICATED_MULTIPLIER_CIRCUITRY="YES" DENORMAL_SUPPORT="NO" DEVICE_FAMILY="Stratix" PIPELINE=5 REDUCED_FUNCTIONALITY="NO" WIDTH_EXP=8 WIDTH_MAN=23 clock dataa datab result
...
module  MultiplierPolynomial_altfp_mult_f7j
	( 
	clock,
	dataa,
	datab,
...
endmodule //MultiplierPolynomial_altfp_mult_f7j
//VALID FILE
...
module MultiplierPolynomial (
	...
	MultiplierPolynomial_altfp_mult_f7j	MultiplierPolynomial_altfp_mult_f7j_component (
				.dataa (dataa),
				.datab (datab),
				.clock (clock),
				.result (sub_wire0));
