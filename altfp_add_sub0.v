...
//altfp_add_sub CBX_AUTO_BLACKBOX="ALL" DENORMAL_SUPPORT="NO" DEVICE_FAMILY="Stratix II" DIRECTION="VARIABLE" OPTIMIZE="SPEED" PIPELINE=14 REDUCED_FUNCTIONALITY="NO" WIDTH_EXP=8 WIDTH_MAN=23 add_sub clock dataa datab result
...
module  altfp_add_sub0_altbarrel_shift_j1e
	( 
	aclr,
	clk_en,
	clock,
...
endmodule //altfp_add_sub0_altbarrel_shift_j1e


//altbarrel_shift CBX_AUTO_BLACKBOX="ALL" DEVICE_FAMILY="Stratix II" PIPELINE=2 REGISTER_OUTPUT="NO" SHIFTDIR="RIGHT" WIDTH=26 WIDTHDIST=5 aclr clk_en clock data distance result
//VERSION_BEGIN 9.0 cbx_altbarrel_shift 2008:08:28:01:40:10:SJ cbx_mgl 2009:01:29:16:12:07:SJ  VERSION_END
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  altfp_add_sub0_altbarrel_shift_q4g
	( 
	aclr,
	clk_en,
	clock,
...
`endif
	...
	assign
		...
		smux_w = {((({26{(sel_w[4] & (~ dir_w[4]))}} & {sbit_w[113:104], pad_w[15:0]}) | ({26{(sel_w[4] & dir_w[4])}} & {pad_w[15:0], sbit_w[129:120]})) | ({26{(~ sel_w[4])}} & sbit_w[129:104])), ((({26{(sel_w[3] & (~ dir_w[3]))}} & {sbit_w[95:78], pad_w[7:0]}) | ({26{(sel_w[3] & dir_w[3])}} & {pad_w[7:0], sbit_w[103:86]})) | ({26{(~ sel_w[3])}} & sbit_w[103:78])), ((({26{(sel_w[2] & (~ dir_w[2]))}} & {sbit_w[73:52], pad_w[3:0]}) | ({26{(sel_w[2] & dir_w[2])}} & {pad_w[3:0], sbit_w[77:56]})) | ({26{(~ sel_w[2])}} & sbit_w[77:52])), ((({26{(sel_w[1] & (~ dir_w[1]))}} & {sbit_w[49:26], pad_w[1:0]}) | ({26{(sel_w[1] & dir_w[1])}} & {pad_w[1:0], sbit_w[51:28]})) | ({26{(~ sel_w[1])}} & sbit_w[51:26])), ((({26{(sel_w[0] & (~ dir_w[0]))}} & {sbit_w[24:0], pad_w[0]}) | ({26{(sel_w[0] & dir_w[0])}} & {pad_w[0], sbit_w[25:1]})) | ({26{(~ sel_w[0])}} & sbit_w[25:0]))};
endmodule //altfp_add_sub0_altbarrel_shift_q4g
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  altfp_add_sub0_altpriority_encoder_uv8
	( 
	data,
	q) ;
	input   [15:0]  data;
...
endmodule //altfp_add_sub0_altpriority_encoder_uv8
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  altfp_add_sub0_altpriority_encoder_ue9
	( 
	data,
	q,
	zero) ;
...
endmodule //altfp_add_sub0_altpriority_encoder_ue9

//synthesis_resources = reg 5 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  altfp_add_sub0_altpriority_encoder_ou8
	( 
	aclr,
	clk_en,
	clock,
...
`endif
	...
	altfp_add_sub0_altpriority_encoder_uv8   altpriority_encoder7
	( 
	.data(data[15:0]),
	.q(wire_altpriority_encoder7_q));
	altfp_add_sub0_altpriority_encoder_ue9   altpriority_encoder8
	( 
	.data(data[31:16]),
...
endmodule //altfp_add_sub0_altpriority_encoder_ou8
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  altfp_add_sub0_altpriority_encoder_2h9
	( 
	data,
	q,
	zero) ;
...
endmodule //altfp_add_sub0_altpriority_encoder_2h9

//synthesis_resources = reg 5 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  altfp_add_sub0_altpriority_encoder_d6b
	( 
	aclr,
	clk_en,
	clock,
...
`endif
	...
	altfp_add_sub0_altpriority_encoder_2h9   altpriority_encoder23
	( 
	.data(data[7:0]),
	.q(wire_altpriority_encoder23_q),
	.zero(wire_altpriority_encoder23_zero));
	altfp_add_sub0_altpriority_encoder_2h9   altpriority_encoder24
	( 
	.data(data[15:8]),
...
endmodule //altfp_add_sub0_altpriority_encoder_d6b
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  altfp_add_sub0_altpriority_encoder_229
	( 
	data,
	q) ;
	input   [7:0]  data;
...
endmodule //altfp_add_sub0_altpriority_encoder_229

//synthesis_resources = reg 4 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  altfp_add_sub0_altpriority_encoder_ena
	( 
	aclr,
	clk_en,
	clock,
...
`endif
	...
	altfp_add_sub0_altpriority_encoder_2h9   altpriority_encoder29
	( 
	.data(data[7:0]),
	.q(wire_altpriority_encoder29_q),
	.zero(wire_altpriority_encoder29_zero));
	altfp_add_sub0_altpriority_encoder_229   altpriority_encoder30
	( 
	.data(data[15:8]),
...
endmodule //altfp_add_sub0_altpriority_encoder_ena

//synthesis_resources = reg 14 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  altfp_add_sub0_altpriority_encoder_dna
	( 
	aclr,
	clk_en,
	clock,
...
`endif
	...
	altfp_add_sub0_altpriority_encoder_d6b   altpriority_encoder21
	( 
	.aclr(aclr),
	.clk_en(clk_en),
	.clock(clock),
	...
	altfp_add_sub0_altpriority_encoder_ena   altpriority_encoder22
	( 
	.aclr(aclr),
	.clk_en(clk_en),
	.clock(clock),
...
endmodule //altfp_add_sub0_altpriority_encoder_dna

//synthesis_resources = lpm_add_sub 14 lpm_compare 1 reg 821 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  altfp_add_sub0_altfp_add_sub_ibk
	( 
	add_sub,
	clock,
	dataa,
...
`endif
	...
	altfp_add_sub0_altbarrel_shift_j1e   lbarrel_shift
	( 
	.aclr(aclr),
	.clk_en(clk_en),
	.clock(clock),
	...
	altfp_add_sub0_altbarrel_shift_q4g   rbarrel_shift
	( 
	.aclr(aclr),
	.clk_en(clk_en),
	.clock(clock),
	...
	altfp_add_sub0_altpriority_encoder_ou8   leading_zeroes_cnt
	( 
	.aclr(aclr),
	.clk_en(clk_en),
	.clock(clock),
	...
	altfp_add_sub0_altpriority_encoder_dna   trailing_zeros_cnt
	( 
	.aclr(aclr),
	.clk_en(clk_en),
	.clock(clock),
...
endmodule //altfp_add_sub0_altfp_add_sub_ibk
//VALID FILE
...
module altfp_add_sub0 (
	...
	altfp_add_sub0_altfp_add_sub_ibk	altfp_add_sub0_altfp_add_sub_ibk_component (
				.dataa (dataa),
				.add_sub (add_sub),
				.datab (datab),
				.clock (clock),
...
// Retrieval info: GEN_FILE: TYPE_NORMAL altfp_add_sub0.inc TRUE
...
// Retrieval info: GEN_FILE: TYPE_NORMAL altfp_add_sub0_bb.v FALSE
